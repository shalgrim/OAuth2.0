...
menuItem3 = MenuItem(
    name='Spicy Tuna Roll', description='', price='', course='', restaurant=restaurant2
)
...
menuItem4 = MenuItem(
    name='Nepali Momo ', description='', price='', course='', restaurant=restaurant2
)
...
menuItem5 = MenuItem(
    name='Beef Noodle Soup', description='', price='', course='', restaurant=restaurant2
)
...
menuItem1 = MenuItem(
    name='Shellfish Tower', description='', price='', course='', restaurant=restaurant1
)
...
menuItem2 = MenuItem(
    name='Chicken and Rice', description='', price='', course='', restaurant=restaurant1
)
...
menuItem3 = MenuItem(
    name="Mom's Spaghetti", description='', price='', course='', restaurant=restaurant1
)
